...
public final class JavaServiceDistributionPlugin implements Plugin<Project> {
    ...
    private static final String GO_JAVA_LAUNCHER = "com.palantir.launching:go-java-launcher:1.5.2";
    private static final String GO_INIT = "com.palantir.launching:go-init:1.5.2";
